      ...
      <div class="row">
        <div class="col-12">
          <div class="header-wrapper">
            <!-- site logo -->
            <div class="site_logo">
              <a class="logo brand-logo" href="/" aria-label="Global Experts for Industrial Development and Green Consultations">
            ...
            <div class="menu-area d-none d-lg-inline-flex align-items-center">
              <nav id="mobile-menu" class="mainmenu">
                <ul>
                          ...
                          <div class="container-fluid gap-60-25">
                            <div class="row">
                                ...
                                <div class="tj-demo-thumb ">
                                  <div class="image">
                                    ...
                                    <div class="tj-demo-button">
                                      <a href="/" class="tj-primary-btn header_btn">
                                  ...
                                  <h6 class="tj-demo-title"><a href="/">Homepage
                                      -
                                      01</a></h6>
                              ...
                              <div class="col-xl-3 col-lg-3 col-12">
                                <div class="tj-demo-thumb">
                                  <div class="image">
                                    ...
                                    <div class="tj-demo-button">
                                      <a href="/index-2" class="tj-primary-btn header_btn">
                                        <span class="btn-text"><span>View demo</span></span>
                                        <span class="btn-icon"><i class="tji-arrow-right-long"></i></span>
                                      </a>
                                    </div>
                                  ...
                                  <h6 class="tj-demo-title"><a href="/index-2">Homepage
                                      -
                                      02</a></h6>
                              ...
                              <div class="col-xl-3 col-lg-3 col-12">
                                <div class="tj-demo-thumb">
                                  <div class="image">
                                    ...
                                    <div class="tj-demo-button">
                                      <a href="/index-3" class="tj-primary-btn header_btn">
                                        <span class="btn-text"><span>View demo</span></span>
                                        <span class="btn-icon"><i class="tji-arrow-right-long"></i></span>
                                      </a>
                                    </div>
                                  </div>
                                  <h6 class="tj-demo-title"><a href="/index-3">Homepage
                                      -
                                      03</a></h6>
                              ...
                              <div class="col-xl-3 col-lg-3 col-12">
                                <div class="tj-demo-thumb ">
                                  <div class="image">
                                    ...
                                    <div class="tj-demo-button">
                                      <a href="/index-4" class="tj-primary-btn header_btn">
                                        <span class="btn-text"><span>View demo</span></span>
                                        <span class="btn-icon"><i class="tji-arrow-right-long"></i></span>
                                      </a>
                                    </div>
                                  </div>
                                  <h6 class="tj-demo-title"><a href="/index-4">Homepage
                                      -
                                      04</a></h6>
                                </div>
                              </div>
                              <div class="col-xl-3 col-lg-3 col-12">
                                <div class="tj-demo-thumb">
                                  <div class="image">
                                    ...
                                    <div class="tj-demo-button">
                                      <a href="/index-5" class="tj-primary-btn header_btn">
                                        <span class="btn-text"><span>View demo</span></span>
                                        <span class="btn-icon"><i class="tji-arrow-right-long"></i></span>
                                      </a>
                                    </div>
                                  </div>
                                  <h6 class="tj-demo-title"><a href="/index-5">Homepage
                                      -
                                      05</a></h6>
                              ...
                              <div class="col-xl-3 col-lg-3 col-12">
                                <div class="tj-demo-thumb ">
                                  <div class="image">
                                    <img src="/assets/images/header/demo/home-11.webp" alt="">
                                    <h6 class="tj-demo-badge tj-zoom-in-out-anim">
                                      New
                                    </h6>
                                    <div class="tj-demo-button">
                              ...
                              <div class="col-xl-3 col-lg-3 col-12">
                                <div class="tj-demo-thumb coming">
                                  <div class="image">
                                    <img src="/assets/images/header/demo/comming-soon.webp" alt="">
                                  </div>
                                  <h6 class="tj-demo-title"><a href="/index-11">Coming soon</a></h6>
                  ...
                  <li class="has-dropdown"><a href="/about">Pages</a>
                        ...
                        <div class="mega-menu-wrapper">
                          ...
                          <div class="mega-menu-pages-single">
                            <div class="mega-menu-pages-single-inner">
                              ...
                              <div class="mega-menu-list">
                                ...
                                <a href="/blog-grid">Blog grid <span
                                    class="mega-menu-badge tj-zoom-in-out-anim ">NEW</span></a>
                          ...
                          <div class=" mega-menu-pages-single">
                            <div class="mega-menu-pages-single-inner">
                              ...
                              <div class="mega-menu-list">
                                <a href="/shop">Shop <span
                                    class="mega-menu-badge tj-zoom-in-out-anim mega-menu-badge-hot ">HOT</span></a>
                                <a href="/shop-details">Shop details </a>
                                <a href="/cart">Cart</a>
                                <a href="/checkout">Checkout</a>
                                <a href="/wishlist">Wishlist<span
                                    class="mega-menu-badge tj-zoom-in-out-anim ">NEW</span></a>
                  ...
                  <li class="has-dropdown"><a href="/service">Services</a>
                    <ul class="sub-menu  mega-menu-service">
                      <li> <a class="mega-menu-service-single" href="/service-details"> <span
                  ...
                  <li class="has-dropdown"><a href="/portfolio">Portfolio</a>
                    <ul class="sub-menu">
...
export function PrimaryHeader() {
  return <header className="header-area header-1 header-absolute  section-gap-x" dangerouslySetInnerHTML={{ __html: html }} />;
}
